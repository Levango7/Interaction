...
// 命名约定：v{应用版本}-{日期}{当日序号}。当前应用版本 1.9.9。
// v1.9.9-20260815d：顶栏顺序调整（搜索·命令·消息·主题·下载·更多）+ 折叠回归侧栏顶部 + 侧栏 4 组大重排（全局/场景/功能/系统）+ 仓库 3 tab（热/温/冷）+ 文档改名 + Agent 新增占位入口。
// v1.9.8-20260815c：侧栏四组对齐设计图（全局/场景/功能/系统）+ 折叠按钮+消息栏+大模型选择器迁正文顶部第二行。
var CACHE_VERSION = "v1.9.9-20260815d";

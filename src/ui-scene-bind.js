    ...
    <div class="recycle-card u-max-w-560">
      ...
      <form id="taskEditForm" class="u-flex u-flex-col u-pad-5-6 u-gap-4">
        ...
        <div class="form-row form-row--grid u-mb-0">
          <div class="fld"><label>${t("field.dueDate","截止日期")}</label><input name="due" type="text" data-date-picker="1" autocomplete="off" value="${esc(task.due||"")}" placeholder="${t("placeholder.dueDate","选日期")}"></div>
